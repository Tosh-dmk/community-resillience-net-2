...
import { G as t, n } from "./useStore-75krDqnZ.js";
import { J as r, K as i, Y as a, q as o } from "./index-B9tAZozu.js";
function s(e) {
...
function p(e, t) {
  ...
  if (t && typeof t == `object`) for (let e of Object.keys(t)) f(e) && (n[e] = t[e]);
  return n;
}
function m(e) {
  ...
  g = (e, t) => {
    ...
    return Object.assign((e) => g(void 0, { ...n, ...e }), {
      ...
      middleware: (e) => {
        let t = [...(n.middleware || [])];
        e.map((e) => {
          a in e ? e.options.middleware && t.push(...e.options.middleware) : t.push(e);
        });
...
async function _(e, t, n) {
  let a = v([...(r()?.functionMiddleware || []), ...e]);
  if (t === `server`) {
    let e = h({ throwIfNotFound: !1 });
    e?.executedRequestMiddlewares && (a = a.filter((t) => !e.executedRequestMiddlewares.has(t)));
  }
  let o = async (e) => {
    let n = a.shift();
    if (!n) return e;
    try {
      ...
      (!r && `inputValidator` in n.options && (r = n.options.inputValidator),
        r && t === `server` && (e.data = await y(r, e.data)));
      let a;
      if (
        (t === `client`
