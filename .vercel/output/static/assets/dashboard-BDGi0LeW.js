...
import { a as r, o as i } from "./Logo-B79n9_zK.js";
...
import { t as u } from "./clock-3-CstUfu5X.js";
import { t as d } from "./sprout-Bvb5UyZs.js";
import { M as f, O as p, a as m, b as h, i as g, k as _, x as v } from "./index-B9tAZozu.js";
import { t as y } from "./progress-8oDtM87l.js";
import { t as b } from "./climateData-DRX9uuxW.js";
var x = i(`file-plus-corner`, [
    [
      `path`,
      {
  ...
  w = [`submitted`, `under_review`, `matched`, `in_progress`, `resolved`],
  T = {
    submitted: `Submitted`,
...
function D(e) {
  let t = w.indexOf(e);
  return Math.round(((t + 1) / w.length) * 100);
}
function O() {
  let { user: e } = r(),
    { data: i = [], isLoading: w } = f(h(e?.id)),
    { data: O = [] } = f(v());
  if (w) return (0, S.jsx)(g, {});
  let k = e?.user_metadata?.full_name?.split(` `)[0] ?? e?.email?.split(`@`)[0] ?? `there`,
    A = O.slice(0, 3),
    j = i[0],
    M = j ? (C[j.disaster_type] ?? C.other) : null,
    N = M ? b.filter((e) => M.grantTags.some((t) => e.tags.includes(t))).slice(0, 3) : [];
  return (0, S.jsx)(m, {
            ...
            (0, S.jsxs)(`div`, {
              ...
              children: [
                (0, S.jsx)(n, {
                  ...
                  children: (0, S.jsxs)(t, {
                    to: `/funding`,
                    children: [(0, S.jsx)(s, { className: `size-4` }), ` Find Funding`],
                  }),
                }),
                (0, S.jsx)(n, {
                  asChild: !0,
                  ...
                  children: (0, S.jsxs)(t, {
                    to: `/report`,
                    children: [(0, S.jsx)(x, { className: `size-4` }), ` New report`],
                  }),
                }),
              ],
            }),
          ...
          ? (0, S.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, S.jsx)(n, {
                  ...
                  children: (0, S.jsx)(t, { to: `/report`, children: `Report damage` }),
                }),
              ],
            })
          : (0, S.jsxs)(`div`, {
                      ...
                      (0, S.jsxs)(`div`, {
                        ...
                        children: [
                          (0, S.jsxs)(`div`, {
                            ...
                            children: [
                              (0, S.jsx)(d, { className: `size-5 text-accent` }),
                              (0, S.jsx)(`h2`, {
                          ...
                          (0, S.jsxs)(`div`, {
                            ...
                            children: [
                              (0, S.jsx)(o, { className: `size-4 shrink-0 text-amber-600` }),
                              (0, S.jsxs)(`p`, {
                          ...
                          (0, S.jsxs)(`div`, {
                            ...
                            children: [
                              (0, S.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, S.jsx)(s, { className: `size-5 text-accent` }),
                                  (0, S.jsx)(`h2`, {
                                    className: `font-serif text-lg font-semibold text-foreground`,
                              ...
                              (0, S.jsx)(n, {
                                ...
                                children: (0, S.jsxs)(t, {
                                  ...
                                  children: [
                                    `See all `,
                                    (0, S.jsx)(a, { className: `size-3 ml-1` }),
                                  ],
                                }),
                              }),
                            ],
                    ...
                    j &&
                      (0, S.jsxs)(`div`, {
                        ...
                        children: [
                            ...
                            children: [
                              (0, S.jsxs)(`div`, {
                                children: [
                                  (0, S.jsxs)(`h2`, {
                                    className: `font-serif text-lg font-semibold text-foreground`,
                                    children: [E[j.disaster_type], ` recovery — `, j.location],
                                  }),
                                  (0, S.jsx)(`p`, {
                          ...
                          (0, S.jsx)(y, { value: D(j.status), className: `mt-6 h-3` }),
                          (0, S.jsx)(`div`, {
                            className: `mt-4 flex flex-wrap gap-2`,
                            children: j.needs.map((e) =>
                              (0, S.jsx)(
                                `span`,
                                {
                                  ...
                                  (0, S.jsxs)(`div`, {
                                    ...
                                    children: [
                                      ...
                                      (0, S.jsxs)(`h4`, {
                                        ...
                                        children: [E[e.disaster_type], ` — `, e.location],
                                      }),
                                    ],
                                  }),
                                  (0, S.jsx)(`p`, {
                ...
                (0, S.jsxs)(`aside`, {
                  ...
                  children: [
                    (0, S.jsxs)(`div`, {
                      ...
                      children: [
                        (0, S.jsxs)(`div`, {
                          ...
                          children: [
                            (0, S.jsx)(p, { className: `size-4`, "aria-hidden": `true` }),
                            ` Recovery Assistant`,
                          ],
                        }),
                        (0, S.jsx)(`p`, {
                    ...
                    (0, S.jsxs)(`div`, {
                      ...
                      children: [
                        (0, S.jsx)(c, { className: `size-5 text-accent mb-2` }),
                        (0, S.jsx)(`p`, {
                          ...
                          children: [
                            (0, S.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, S.jsx)(a, { className: `size-4 shrink-0 text-accent` }),
                              ],
                            }),
                            (0, S.jsx)(`p`, {
