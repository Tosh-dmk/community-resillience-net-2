...
import { t as a } from "./badge-dollar-sign-DkJHWVtV.js";
import { t as o } from "./building-2-T_UotKfj.js";
import { t as s } from "./circle-check-CPytu466.js";
import { t as c } from "./clock-3-CstUfu5X.js";
import { t as l } from "./globe-C4OcK3P6.js";
import { t as u } from "./loader-circle-CHqB8Jlp.js";
import { t as d } from "./map-pin-nduRdDCE.js";
import { t as f } from "./send-Bu1cOtSv.js";
import { t as p } from "./shield-check-DYzUTOe_.js";
import { t as m } from "./trending-up-CP-mUrrk.js";
import { t as h } from "./users-BMIJ3Mt2.js";
import { E as g, a as _, k as v, w as y } from "./index-B9tAZozu.js";
import { t as b } from "./progress-8oDtM87l.js";
var x = i(`arrow-up-right`, [
  ...
  D = {
    ...
    in_progress: { label: `In Progress`, color: `bg-brand-100 text-brand-800`, icon: C },
    resolved: {
      label: `Resolved`,
  ...
  A = [
    ...
    { region: `Northern Kenya (ASAL)`, disbursed: 1480, goal: 2e3, type: `Drought Relief` },
...
function M() {
  let [e, t] = (0, w.useState)(`beneficiaries`),
    [n, i] = (0, w.useState)(E),
    [c, g] = (0, w.useState)(null),
    [M, N] = (0, w.useState)(null),
    P = (e) => {
      (N(e),
        setTimeout(() => {
          (i((t) => t.map((t) => (t.id === e ? { ...t, status: `matched` } : t))),
            N(null),
            y.success(`Damage verified. Beneficiary matched with aid programs.`));
        }, 1400));
    },
    F = (e) => {
      (g(e.id),
        window.dispatchEvent(
          new CustomEvent(`demo:stk`, {
            detail: { amount: 8500, account: `HB-${e.id.toUpperCase()}` },
          }),
        ),
        setTimeout(() => {
          (i((t) => t.map((t) => (t.id === e.id ? { ...t, status: `in_progress` } : t))),
            g(null),
            y.success(`Cash assistance dispatched to ${e.name} via M-Pesa.`),
            window.dispatchEvent(
              new CustomEvent(`demo:sms`, {
                detail: {
                  title: `HopeBridge Disbursement`,
                  body: `KES 8,500 emergency cash assistance has been sent to ${e.name} (${e.county} County) via M-Pesa. Ref: HB-${e.id.toUpperCase()}-CASH.`,
                },
              }),
            ));
        }, 2e3));
    ...
    I = (e) => {
      (i((t) => t.map((t) => (t.id === e ? { ...t, status: `resolved` } : t))),
        y.success(`Case marked as resolved.`));
    },
    L = n.reduce((e, t) => ((e[t.status] = (e[t.status] || 0) + 1), e), {});
  return (0, T.jsx)(_, {
    children: (0, T.jsxs)(`div`, {
      ...
      children: [
        (0, T.jsxs)(`header`, {
          ...
          children: [
            (0, T.jsxs)(`div`, {
              ...
              children: [(0, T.jsx)(o, { className: `size-3.5` }), `Disaster Operations Portal`],
            }),
            (0, T.jsxs)(`div`, {
                ...
                (0, T.jsxs)(`div`, {
                  ...
                  children: [
                    (0, T.jsxs)(r, {
                      ...
                      children: [(0, T.jsx)(S, { className: `size-4 mr-1.5` }), ` Export Report`],
                    }),
                    (0, T.jsxs)(r, {
                      size: `sm`,
                      className: `rounded-full`,
                      children: [(0, T.jsx)(f, { className: `size-4 mr-1.5` }), ` Broadcast Alert`],
                    }),
                  ],
                }),
              ],
        ...
        (0, T.jsx)(`div`, {
          ...
          children: [
            { key: `beneficiaries`, label: `Beneficiary Pipeline`, icon: h },
            { key: `impact`, label: `Impact & Finance`, icon: m },
            { key: `saas`, label: `SaaS & Pricing`, icon: a },
          ].map((n) =>
            (0, T.jsxs)(
              `button`,
              {
                id: `ops-tab-${n.key}`,
                onClick: () => t(n.key),
                className: `flex items-center gap-1.5 pb-3 px-2 text-sm font-semibold border-b-2 transition-colors cursor-pointer ${e === n.key ? `border-accent text-accent` : `border-transparent text-muted-foreground hover:text-foreground`}`,
                children: [(0, T.jsx)(n.icon, { className: `size-4` }), n.label],
              },
              n.key,
            ),
          ),
          ...
          (0, T.jsxs)(`div`, {
            children: [
              (0, T.jsx)(`div`, {
                ...
                children: Object.entries(D).map(([e, t]) =>
                  (0, T.jsxs)(
                    `div`,
                    {
                            ...
                            children: [
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, T.jsxs)(`span`, {
                                    className: `flex items-center gap-1 rounded-full px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide ${t.color}`,
                                    children: [(0, T.jsx)(n, { className: `size-3` }), t.label],
                                  }),
                                  (0, T.jsxs)(`span`, {
                                    className: `rounded-md bg-muted px-2 py-0.5 text-[10px] font-medium text-muted-foreground`,
                                    children: [`Severity `, e.severity, `/5`],
                                  }),
                                ],
                              }),
                              (0, T.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, T.jsxs)(`span`, {
                                    ...
                                    children: [
                                      (0, T.jsx)(d, { className: `size-3` }),
                                      e.county,
                                      ` County`,
                                    ],
                                  }),
                                  (0, T.jsx)(`span`, { children: `•` }),
                                  (0, T.jsx)(`span`, { children: O[e.disasterType] }),
                                  (0, T.jsx)(`span`, { children: `•` }),
                                  (0, T.jsx)(`span`, { children: e.submitted }),
                                ],
                              }),
                              (0, T.jsx)(`div`, {
                                className: `mt-2 flex flex-wrap gap-1.5`,
                                children: e.needs.map((e) =>
                                  (0, T.jsx)(
                                    `span`,
                                    {
                                      className: `rounded-md bg-muted px-2 py-0.5 text-[10px] font-medium text-muted-foreground`,
                            ...
                            children: [
                              e.status === `submitted` || e.status === `under_review`
                                ? (0, T.jsx)(r, {
                                    ...
                                    children: o
                                      ...
                                      : (0, T.jsxs)(T.Fragment, {
                                          children: [
                                            (0, T.jsx)(p, { className: `size-3 mr-1` }),
                                            ` Verify Damage`,
                                          ],
                                        }),
                                  })
                                : null,
                              e.status === `matched` || e.status === `in_progress`
                                ? (0, T.jsx)(r, {
                                    size: `sm`,
                                    className: `rounded-full text-xs`,
                                    onClick: () => F(e),
                                    disabled: i || e.status === `in_progress`,
                                    children: i
                                      ? (0, T.jsxs)(T.Fragment, {
                                          children: [
                                            (0, T.jsx)(u, {
                                      ...
                                      : e.status === `in_progress`
                                        ? (0, T.jsxs)(T.Fragment, {
                                            children: [
                                              (0, T.jsx)(C, { className: `size-3 mr-1` }),
                                              ` Disbursed`,
                                            ],
                                          })
                                        : (0, T.jsxs)(T.Fragment, {
                                            children: [
                                              (0, T.jsx)(a, { className: `size-3 mr-1` }),
                                              ` Disburse Cash`,
                                            ],
                                          }),
                                  })
                              ...
                              e.status === `in_progress`
                                ? (0, T.jsxs)(r, {
                                    ...
                                    onClick: () => I(e.id),
                                    children: [
                                      (0, T.jsx)(s, { className: `size-3 mr-1` }),
                                      ` Mark Resolved`,
                                    ],
                                  })
                                : null,
                ...
                children: k.map((e) =>
                  (0, T.jsxs)(
                    `div`,
                    {
                      ...
                      children: [
                        (0, T.jsx)(`div`, {
                          className: `mb-3 flex size-10 items-center justify-center rounded-xl ${e.bg}`,
                          children: (0, T.jsx)(e.icon, { className: `size-5 ${e.color}` }),
                        }),
                        (0, T.jsx)(`p`, {
                        ...
                        (0, T.jsxs)(`p`, {
                          ...
                          children: [(0, T.jsx)(x, { className: `size-3` }), e.change],
                        }),
                      ],
                    },
                    e.label,
              ...
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, T.jsx)(`div`, {
                    className: `space-y-4`,
                    children: A.map((e) => {
                      let t = Math.round((e.disbursed / e.goal) * 100);
                      return (0, T.jsxs)(
                        `div`,
                        {
                          children: [
                            (0, T.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, T.jsxs)(`span`, {
                                  ...
                                  children: [`KES `, e.disbursed, `M / `, e.goal, `M (`, t, `%)`],
                                }),
                              ],
                            }),
                            (0, T.jsx)(b, { value: t, className: `h-2` }),
                          ],
                        },
                        e.region,
                      );
              ...
              (0, T.jsxs)(`div`, {
                ...
                children: [
                  (0, T.jsxs)(`div`, {
                    ...
                    children: [
                      (0, T.jsx)(v, { className: `size-8 mx-auto text-amber-500 mb-2` }),
                      (0, T.jsx)(`p`, {
                  ...
                  (0, T.jsxs)(`div`, {
                    className: `rounded-2xl border border-border bg-card p-5 text-center`,
                    children: [
                      (0, T.jsx)(l, { className: `size-8 mx-auto text-accent mb-2` }),
                      (0, T.jsx)(`p`, {
                        className: `font-serif text-3xl font-semibold text-foreground`,
                        children: `62%`,
                      }),
                  ...
                  (0, T.jsxs)(`div`, {
                    className: `rounded-2xl border border-border bg-card p-5 text-center`,
                    children: [
                      (0, T.jsx)(a, { className: `size-8 mx-auto text-emerald-500 mb-2` }),
                      (0, T.jsx)(`p`, {
                        className: `font-serif text-3xl font-semibold text-foreground`,
                        children: `KES 8,200`,
                      }),
              ...
              (0, T.jsx)(`div`, {
                ...
                children: j.map((e) =>
                  (0, T.jsxs)(
                    `div`,
                    {
                      className: `relative flex flex-col rounded-3xl border p-6 ${e.accent ? `border-accent bg-primary text-primary-foreground` : `border-border bg-card`}`,
                      children: [
                        e.tag &&
                          (0, T.jsx)(`div`, {
                            className: `absolute -top-3 left-6 rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-wider ${e.accent ? `bg-accent text-white` : `bg-brand-100 text-brand-800`}`,
                            children: e.tag,
                          }),
                        (0, T.jsxs)(`div`, {
                          className: `mb-5`,
                          children: [
                            (0, T.jsx)(`h3`, {
                              className: `font-serif text-lg font-semibold ${e.accent ? `text-primary-foreground` : `text-foreground`}`,
                              children: e.name,
                            }),
                            (0, T.jsxs)(`div`, {
                              ...
                              children: [
                                (0, T.jsx)(`span`, {
                                  className: `font-serif text-3xl font-bold ${e.accent ? `text-primary-foreground` : `text-foreground`}`,
                                  children: e.price,
                                }),
                                (0, T.jsx)(`span`, {
                                  className: `text-sm ${e.accent ? `text-primary-foreground/70` : `text-muted-foreground`}`,
                                  children: e.period,
                                }),
                              ],
                            }),
                            (0, T.jsx)(`p`, {
                              className: `mt-2 text-sm ${e.accent ? `text-primary-foreground/75` : `text-muted-foreground`}`,
                        ...
                        (0, T.jsx)(`ul`, {
                          ...
                          children: e.features.map((t) =>
                            (0, T.jsxs)(
                              `li`,
                              {
                                className: `flex items-start gap-2 text-sm ${e.accent ? `text-primary-foreground/85` : `text-muted-foreground`}`,
                                children: [
                                  (0, T.jsx)(s, {
                                    className: `size-4 shrink-0 mt-0.5 ${e.accent ? `text-primary-foreground` : `text-accent`}`,
                                  }),
                                  t,
                                ],
                              },
                        ...
                        (0, T.jsx)(r, {
                          variant: e.accent ? `secondary` : `default`,
                          className: `w-full rounded-full`,
                          size: `sm`,
                          onClick: () =>
                            y.success(
                              `${e.cta} — HopeBridge sales team will reach out within 24 hours.`,
                            ),
                          children: e.cta,
                        }),
                      ],
                    ...
                    children: [
                      ...
                      (0, T.jsxs)(
                        `div`,
                        {
                          ...
                          children: [
                            (0, T.jsx)(p, { className: `size-5 text-accent mb-2` }),
                            (0, T.jsx)(`p`, {
