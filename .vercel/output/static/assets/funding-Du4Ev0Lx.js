...
import { o } from "./Logo-B79n9_zK.js";
import { t as s } from "./useMutation-BNzYlUKz.js";
import { t as c } from "./useSuspenseQuery-BhLrdu7W.js";
import { n as l, t as u } from "./wifi-off-BRtn41Cm.js";
import { t as d } from "./badge-dollar-sign-DkJHWVtV.js";
import { t as f } from "./circle-check-CPytu466.js";
import { t as p } from "./globe-C4OcK3P6.js";
import { t as m } from "./loader-circle-CHqB8Jlp.js";
import { t as h } from "./search-Dev9YtHV.js";
import { t as g } from "./trending-up-CP-mUrrk.js";
import { G as _, T as v, a as y, k as b, x } from "./index-B9tAZozu.js";
import { t as S } from "./progress-8oDtM87l.js";
import { t as C } from "./climateData-DRX9uuxW.js";
import { t as w } from "./input-nIY2wL7O.js";
var T = o(`funnel`, [
    [
      `path`,
      {
  ...
  O = a({ method: `POST` }).handler(
    _(`08c0f4a1c7011e203225a5b0245a2799f753c0109e9955231e482d967e4ae04e`),
  ),
  k = n(),
  A = [
    {
  ...
  j = (e) =>
    e.toLocaleString(`en-KE`, { style: `currency`, currency: `KES`, maximumFractionDigits: 0 }),
  M = {
...
function P({ campaign: e, onClose: t }) {
  let [n, a] = (0, D.useState)(``),
    [o, c] = (0, D.useState)(``),
    [l, u] = (0, D.useState)(!1),
    d = i(O),
    p = s({ mutationFn: (e) => d({ data: e }) });
  return (
    (0, D.useEffect)(() => {
      let t = () => {
        (p.mutate({
          ...
          amount: o.trim(),
          paybill: `222911`,
          account: e.title.substring(0, 20).toUpperCase(),
        }),
          u(!1));
      };
      return (
        window.addEventListener(`demo:stk-success`, t),
        () => window.removeEventListener(`demo:stk-success`, t)
      );
    }, [n, o, e.title]),
    (0, k.jsx)(`div`, {
      ...
      children: (0, k.jsxs)(`div`, {
        ...
        children: [
          (0, k.jsx)(`button`, {
            ...
            children: (0, k.jsx)(v, { className: `size-5` }),
          }),
          (0, k.jsx)(`h2`, {
            ...
            : (0, k.jsxs)(`form`, {
                ...
                children: [
                    ...
                    children: [
                      ...
                      (0, k.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, k.jsx)(`span`, {
                            className: `font-bold text-foreground`,
                            children: e.title.substring(0, 20).toUpperCase(),
                          }),
                        ],
                      }),
                    ],
                  ...
                  (0, k.jsxs)(r, {
                    ...
                    children: [
                      l || p.isPending
                        ? (0, k.jsx)(m, { className: `size-4 animate-spin mr-2` })
                        : (0, k.jsx)(E, { className: `size-4 mr-2` }),
                      l
...
function F({ opportunity: e, onClose: t }) {
      ...
      children: [
        ...
        n
          ? (0, k.jsxs)(`div`, {
              ...
              children: [
                (0, k.jsx)(f, { className: `size-12 text-emerald-500 mx-auto mb-4` }),
                (0, k.jsx)(`h2`, {
                ...
                (0, k.jsxs)(`p`, {
                  ...
                  children: [
                    ...
                    (0, k.jsx)(`strong`, { children: e.title }),
                    ` is under review.`,
                  ],
                }),
                (0, k.jsx)(`p`, {
          ...
          : (0, k.jsxs)(k.Fragment, {
              children: [
                (0, k.jsxs)(`div`, {
                  ...
                  children: [
                    (0, k.jsx)(`span`, {
                      className: `rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide ${M[e.type] ?? `bg-muted text-muted-foreground`}`,
                      children: e.type,
                    }),
                    (0, k.jsx)(`h2`, {
                ...
                (0, k.jsxs)(`form`, {
                        ...
                        (g(!1),
                          ...
                          window.dispatchEvent(
                            new CustomEvent(`demo:sms`, {
                              detail: {
                                title: e.provider,
                                body: `Your application for "${e.title}" has been received. Reference: HB-${Math.floor(Math.random() * 9e4) + 1e4}. Verification within 5-7 business days.`,
                              },
                            }),
                          ));
                      }, 1800));
                  ...
                  children: [
                    ...
                    (0, k.jsxs)(`div`, {
                      ...
                      children: [
                        (0, k.jsx)(u, { className: `size-3 inline mr-1` }),
                        `Also accessible offline: dial `,
                        (0, k.jsx)(`code`, { className: `font-mono`, children: `*483*111#` }),
                    ...
                    (0, k.jsx)(r, {
                      ...
                      children: h
                        ...
                        : (0, k.jsxs)(k.Fragment, {
                            children: [
                              `Submit Application `,
                              (0, k.jsx)(l, { className: `size-4 ml-1` }),
                            ],
                          }),
                    }),
                  ],
...
function I() {
  let { data: e } = c(x()),
    ...
    [o, s] = (0, D.useState)(`marketplace`),
    [l, f] = (0, D.useState)(``),
    [m, _] = (0, D.useState)(`all`),
    v = C.filter((e) => {
      let t = m === `all` || e.type === m,
        n = l.trim().toLowerCase(),
        r =
          !n ||
          e.title.toLowerCase().includes(n) ||
          e.provider.toLowerCase().includes(n) ||
          e.type.toLowerCase().includes(n) ||
  ...
  return (0, k.jsxs)(y, {
    children: [
                ...
                children: [
                  ...
                  (0, k.jsxs)(`p`, {
                    ...
                    children: [
                      ...
                      ` → option`,
                      ` `,
                      (0, k.jsx)(`strong`, { children: `3. Climate Grants` }),
                    ],
                  }),
                ],
              }),
          ...
          (0, k.jsxs)(`div`, {
            ...
            children: [
              (0, k.jsxs)(`button`, {
                ...
                className: `pb-3 px-1 text-sm font-semibold border-b-2 transition-colors cursor-pointer ${o === `marketplace` ? `border-accent text-accent` : `border-transparent text-muted-foreground hover:text-foreground`}`,
                children: [
                  (0, k.jsx)(d, { className: `size-4 inline mr-1.5` }),
              ...
              (0, k.jsxs)(`button`, {
                id: `tab-campaigns`,
                onClick: () => s(`campaigns`),
                className: `pb-3 px-1 text-sm font-semibold border-b-2 transition-colors cursor-pointer ${o === `campaigns` ? `border-accent text-accent` : `border-transparent text-muted-foreground hover:text-foreground`}`,
                children: [
                  (0, k.jsx)(E, { className: `size-4 inline mr-1.5` }),
              ...
              children: [
                    ...
                    (0, k.jsx)(`div`, {
                      ...
                      children: N.map((e) =>
                        (0, k.jsx)(
                          r,
                          {
                            variant: m === e.value ? `default` : `outline`,
                            size: `sm`,
                ...
                (0, k.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    (0, k.jsxs)(`div`, {
                      className: `flex items-center gap-2 text-sm text-muted-foreground`,
                      children: [(0, k.jsx)(u, { className: `size-4` }), `USSD-accessible`],
                    }),
                  ],
                }),
                (0, k.jsx)(`div`, {
                            ...
                            children: [
                              ...
                              e.ussd &&
                                (0, k.jsxs)(`span`, {
                                  ...
                                  children: [(0, k.jsx)(u, { className: `size-3` }), ` USSD`],
                                }),
                            ],
                          }),
                          (0, k.jsxs)(`div`, {
            ...
            (0, k.jsxs)(`div`, {
              children: [
                (0, k.jsxs)(`div`, {
                  ...
                  children: [
                    (0, k.jsx)(g, { className: `size-5 text-accent` }),
                    (0, k.jsx)(`h2`, {
                ...
                (0, k.jsx)(`div`, {
                  ...
                  children: A.map((e) => {
                    let t = Math.min(100, Math.round((e.raised / e.goal) * 100));
                    return (0, k.jsxs)(
                      `article`,
                      {
                        ...
                        children: [
                          ...
                          (0, k.jsxs)(`div`, {
                            ...
                            children: [
                              (0, k.jsx)(S, { value: t, className: `h-2` }),
                              (0, k.jsxs)(`div`, {
                                ...
                                children: [
                                  ...
                                  (0, k.jsxs)(`span`, {
                                    className: `text-sm text-muted-foreground`,
                                    children: [`of `, j(e.goal)],
                                  }),
                                ],
                              }),
                              (0, k.jsxs)(`p`, {
                                className: `mt-1 text-xs text-muted-foreground`,
                                children: [t, `% funded • `, e.donors, ` donors`],
                              }),
                            ],
                          }),
                          (0, k.jsxs)(r, {
      ...
      t && (0, k.jsx)(P, { campaign: t, onClose: () => n(null) }),
      i && (0, k.jsx)(F, { opportunity: i, onClose: () => a(null) }),
    ],
  });
}
