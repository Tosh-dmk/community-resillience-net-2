...
function g(e, t) {
  let n = ee(),
    ...
    z = m.useMemo(() => {
      let e = { _fromLocation: R, ...L };
      return n.buildLocation(e);
    }, [n, R, L]),
    Ee = z.maskedLocation ? z.maskedLocation.publicHref : z.publicHref,
    De = z.maskedLocation ? z.maskedLocation.external : z.external,
    B = m.useMemo(() => se(Ee, De, n.history, k), [k, De, Ee, n.history]),
    V = m.useMemo(() => {
      if (B?.external) return d(B.href, n.protocolAllowlist) ? void 0 : B.href;
      if (!ce(g) && !(typeof g != `string` || g.indexOf(`:`) === -1))
        try {
          return (new URL(g), d(g, n.protocolAllowlist) ? void 0 : g);
        } catch {}
    }, [g, B, n.protocolAllowlist]),
    Oe = m.useMemo(() => {
      if (V) return !1;
      if (h?.exact) {
        if (!l(R.pathname, z.pathname, n.basepath)) return !1;
      } else {
        let e = a(R.pathname, n.basepath),
          t = a(z.pathname, n.basepath);
        if (!(e.startsWith(t) && (e.length === t.length || e[t.length] === `/`))) return !1;
      }
      return (h?.includeSearch ?? !0) &&
        !i(R.search, z.search, { partial: !h?.exact, ignoreUndefined: !h?.explicitUndefined })
        ? !1
        : h?.includeHash
          ? Te && R.hash === z.hash
          : !0;
    ...
    ke = Oe ? (r(ne, {}) ?? ie) : _,
    Ae = Oe ? _ : (r(f, {}) ?? _),
    je = [j, ke.className, Ae.className].filter(Boolean).join(` `),
    Me = (A || ke.style || Ae.style) && { ...A, ...ke.style, ...Ae.style },
    [Ne, Pe] = m.useState(!1),
    Fe = m.useRef(!1),
    H = e.reloadDocument || V ? !1 : (S ?? n.options.defaultPreload),
    Ie = w ?? n.options.defaultPreloadDelay ?? 0,
    U = m.useCallback(() => {
      n.preloadRoute({ ...L, _builtLocation: z }).catch((e) => {
        (console.warn(e), console.warn(p));
      });
    }, [n, L, z]);
  (c(
    u,
    ...
    oe,
    { disabled: !!k || H !== `viewport` },
  ),
    m.useEffect(() => {
      Fe.current || (!k && H === `render` && (U(), (Fe.current = !0)));
    }, [k, U, H]));
  let Le = (e) => {
    let t = e.currentTarget.getAttribute(`target`),
      r = O === void 0 ? t : O;
    if (!k && !C(e) && !e.defaultPrevented && (!r || r === `_self`) && e.button === 0) {
      (e.preventDefault(),
        (0, re.flushSync)(() => {
          Pe(!0);
        }));
...
var _ = {},
  ie = { className: `active` },
  ae = { role: `link`, "aria-disabled": !0 },
  v = { "data-status": `active`, "aria-current": `page` },
  y = { "data-transitioning": `transitioning` },
  b = new WeakMap(),
  oe = { rootMargin: `100px` },
  x = (e) => (t) => {
    for (let n of e)
...
var S = m.forwardRef((e, t) => {
  ...
  if (!n) {
    let { disabled: e, ...t } = a;
    return m.createElement(`a`, t, o);
  }
  return m.createElement(n, a, o);
});
function C(e) {
...
function E(e) {
  let t = m.forwardRef((t, n) => {
    let { children: r, ...i } = t,
      ...
      o = !1,
      s = [];
    (j(r) && typeof P == `function` && (r = P(r._payload)),
      m.Children.forEach(r, (e) => {
        if (k(e)) {
          o = !0;
          let t = e,
            n = `child` in t.props ? t.props.child : t.props.children;
          (j(n) && typeof P == `function` && (n = P(n._payload)),
            (a = fe(t, n)),
            s.push(a?.props?.children));
        } else s.push(e);
      }),
      a
        ? (a = m.cloneElement(a, void 0, s))
        : !o && m.Children.count(r) === 1 && m.isValidElement(r) && (a = r));
    let c = a ? O(a) : void 0,
      l = T(n, c);
    if (!a) {
      if (r || r === 0) throw Error(o ? N(e) : pe(e));
      return r;
    }
    let ee = D(i, a.props ?? {});
    return (a.type !== m.Fragment && (ee.ref = n ? l : c), m.cloneElement(a, ee));
  });
  return ((t.displayName = `${e}.Slot`), t);
}
var ue = E(`Slot`),
  de = Symbol.for(`radix.slottable`),
  fe = (e, t) => {
    if (`child` in e.props) {
      let t = e.props.child;
      return m.isValidElement(t)
        ? m.cloneElement(t, void 0, e.props.children(t.props.children))
        : null;
    }
...
var me = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  he = I,
  ge = (e, t) => (n) => {
    if (t?.variants == null) return he(e, n?.class, n?.className);
  ...
  ye = (e = new Map(), t = null, n) => ({ nextPart: e, validators: t, classGroupId: n }),
  be = `-`,
  xe = [],
  Se = `arbitrary..`,
  Ce = (e) => {
  ...
  we = (e, t, n) => {
    ...
    let a = n.validators;
    if (a === null) return;
    let o = t === 0 ? e.join(be) : e.slice(t).join(be),
      s = a.length;
    for (let e = 0; e < s; e++) {
      let t = a[e];
  ...
  ke = (e) => `isThemeGetter` in e && e.isThemeGetter === !0,
  Ae = (e) => {
  ...
  Fe = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(je)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(je) && ((c = s.slice(1)), (l = !0));
        let ee = a && a > i ? a - i : void 0;
        return Pe(t, l, c, ee);
      };
    if (t) {
      let e = t + Me,
  ...
  Ie = (e) => ({
    ...
    parseClassName: Fe(e),
    sortModifiers: H(e),
    postfixLookupClassGroupIds: U(e),
    ...Ce(e),
  }),
  U = (e) => {
  ...
  Re = (e, t) => {
    ...
    for (let e = c.length - 1; e >= 0; --e) {
      ...
      let f = !!ne,
        p;
      if (f) {
        p = r(d.substring(0, ne));
        let e = p && o[p] ? r(d) : void 0;
        e && e !== p && ((p = e), (f = !1));
      } else p = r(d);
      if (!p) {
        if (!f) {
      ...
      let m = u.length === 0 ? `` : u.length === 1 ? u[0] : a(u).join(`:`),
        h = te ? m + je : m,
        re = h + p;
      if (s.indexOf(re) > -1) continue;
      s.push(re);
      let g = i(p, f);
  ...
  Ze = (e) => e.endsWith(`%`) && K(e.slice(0, -1)),
  J = (e) => Ke.test(e),
  Qe = () => !0,
  $e = (e) => qe.test(e) && !Je.test(e),
  et = () => !1,
  tt = (e) => Ye.test(e),
  nt = (e) => Xe.test(e),
  rt = (e) => !Y(e) && !Z(e),
  ...
  yt = (e) => e === `position` || e === `percentage`,
  bt = (e) => e === `image` || e === `url`,
  xt = (e) => e === `length` || e === `size` || e === `bg-size`,
  St = (e) => e === `length`,
  Ct = (e) => e === `number`,
  wt = (e) => e === `family-name`,
  Tt = (e) => e === `number` || e === `weight`,
  Et = (e) => e === `shadow`,
  Dt = Ve(() => {
    let e = W(`color`),
      t = W(`font`),
      ...
      v = () => [Z, Y, c],
      y = () => [G, `full`, `auto`, ...v()],
      b = () => [q, `none`, `subgrid`, Z, Y],
      oe = () => [`auto`, { span: [`full`, q, Z, Y] }, q, Z, Y],
      x = () => [q, `auto`, Z, Y],
      se = () => [`auto`, `min`, `max`, `fr`, Z, Y],
      ce = () => [
        `start`,
        `end`,
        `center`,
      ...
      S = () => [`start`, `end`, `center`, `stretch`, `center-safe`, `end-safe`],
      C = () => [`auto`, ...v()],
      w = () => [
        G,
        `auto`,
      ...
      le = () => [G, `screen`, `full`, `dvw`, `lvw`, `svw`, `min`, `max`, `fit`, ...v()],
      T = () => [G, `screen`, `full`, `lh`, `dvh`, `lvh`, `svh`, `min`, `max`, `fit`, ...v()],
      E = () => [e, Z, Y],
      ue = () => [...g(), mt, lt, { position: [Z, Y] }],
      de = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      fe = () => [`auto`, `cover`, `contain`, ht, at, { size: [Z, Y] }],
      D = () => [Ze, ft, X],
      O = () => [``, `none`, `full`, l, Z, Y],
      k = () => [``, K, ft, X],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, G, Y, Z, p] }],
        container: [`container`],
        ...
        "align-self": [{ self: [`auto`, ...S(), { baseline: [``, `last`] }] }],
        ...
        w: [{ w: [s, `screen`, ...w()] }],
        "min-w": [{ "min-w": [s, `screen`, `none`, ...w()] }],
        "max-w": [{ "max-w": [s, `screen`, `none`, `prose`, { screen: [o] }, ...w()] }],
        h: [{ h: [`screen`, `lh`, ...w()] }],
        "min-h": [{ "min-h": [`screen`, `lh`, `none`, ...w()] }],
        "max-h": [{ "max-h": [`screen`, `lh`, ...w()] }],
        "font-size": [{ text: [`base`, n, ft, X] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, vt, st] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        "line-clamp": [{ "line-clamp": [K, `none`, Z, ot] }],
        leading: [{ leading: [a, ...v()] }],
        ...
        "outline-w": [{ outline: [``, K, ft, X] }],
        "outline-color": [{ outline: E() }],
        shadow: [{ shadow: [``, `none`, ee, _t, dt] }],
        "shadow-color": [{ shadow: E() }],
        "inset-shadow": [{ "inset-shadow": [`none`, u, _t, dt] }],
        ...
        "text-shadow": [{ "text-shadow": [`none`, te, _t, dt] }],
        ...
        "drop-shadow": [{ "drop-shadow": [``, `none`, d, _t, dt] }],
        ...
        ease: [{ ease: [`linear`, `initial`, m, Z, Y] }],
        delay: [{ delay: [K, Z, Y] }],
        animate: [{ animate: [`none`, h, Z, Y] }],
        backface: [{ backface: [`hidden`, `visible`] }],
        perspective: [{ perspective: [f, Z, Y] }],
...
var kt = ge(
  ...
  At = m.forwardRef(({ className: e, variant: t, size: n, asChild: r = !1, ...i }, a) =>
    (0, h.jsx)(r ? ue : `button`, {
      className: Ot(kt({ variant: t, size: n, className: e })),
      ref: a,
      ...i,
    }),
  );
At.displayName = `Button`;
export { T as a, E as i, Ot as n, S as o, ge as r, f as s, At as t };
