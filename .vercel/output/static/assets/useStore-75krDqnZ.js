...
function _(e, t, n) {
  ...
  if (m(e) && m(t)) {
    ...
    if (n?.partial) {
      for (let i in t) if ((!r || t[i] !== void 0) && !_(e[i], t[i], n)) return !1;
      return !0;
    }
    let i = 0;
    ...
    let a = 0;
    for (let o in t) if ((!r || t[o] !== void 0) && (a++, a > i || !_(e[o], t[o], n))) return !1;
    return i === a;
  }
  return !1;
}
...
function O(e) {
  ...
  let t = /%25|%5C/gi,
    ...
    r = ``,
    i;
  for (; (i = t.exec(e)) !== null; ) ((r += S(e.slice(n, i.index)) + i[0]), (n = t.lastIndex));
  r += S(n ? e.slice(n) : e);
  let a = !1;
  return (
...
function I(e, t, n = new Uint16Array(6)) {
  let r = e.indexOf(`/`, t),
    i = r === -1 ? e.length : r,
    a = e.substring(t, i);
  if (!a || !a.includes(`$`))
...
function L(e, t, n, r, i, a, o) {
      ...
      switch (((s = d + 1), a++, e[0])) {
        ...
        case 1: {
          ...
          if (h) o = h;
            ...
            let e = V(1, n.fullPath ?? n.from, f, p, m);
        ...
        case 3: {
          ...
          if (h) o = h;
            ...
            let e = V(3, n.fullPath ?? n.from, f, p, m);
  ...
  if (n.children) for (let r of n.children) L(e, t, r, s, i, a, o);
}
function R(e, t) {
...
function z(e) {
  if (e.pathless) for (let t of e.pathless) z(t);
  if (e.static) for (let t of e.static.values()) z(t);
  if (e.staticInsensitive) for (let t of e.staticInsensitive.values()) z(t);
  if (e.dynamic?.length) {
    e.dynamic.sort(R);
    for (let t of e.dynamic) z(t);
  }
  if (e.optional?.length) {
    e.optional.sort(R);
    for (let t of e.optional) z(t);
  }
  if (e.wildcard?.length) {
    e.wildcard.sort(R);
    for (let t of e.wildcard) z(t);
  }
}
function B(e) {
  return {
...
function ee(e, t) {
  let n = B(`/`),
    r = new Uint16Array(6);
  for (let t of e) L(!1, r, t, 1, n, 0);
  (z(n), (t.masksTree = n), (t.flatCache = M(1e3)));
}
function te(e, t) {
  e ||= `/`;
...
function ne(e, t, n, r, i) {
  ...
  return (
    o || ((o = B(`/`)), L(t, new Uint16Array(6), { from: e }, 1, o, 0), i.singleCache.set(a, o)),
    H(r, o, n)
  );
}
function re(e, t, n = !1) {
...
function ae(e, t = !1, n) {
  ...
  return (
    L(t, i, e, 1, r, 0, (e) => {
      if ((n?.(e, s), e.id in a && j(), (a[e.id] = e), s !== 0 && e.path)) {
        let t = ie(e.fullPath);
...
function se(e, t, n, r) {
  ...
  for (; c.length; ) {
    let n = c.pop(),
      { node: i, index: a, skipped: d, depth: f, statics: p, dynamics: m, optionals: h } = n,
    ...
    r && i.route && i.kind !== N && q(l, n) && (l = n);
    let v = a === s;
    if (
      v &&
      (i.route && (!o || i.kind === N || i.kind === 2) && q(u, n) && (u = n),
    ...
    if (i.wildcard)
      for (let e = i.wildcard.length - 1; e >= 0; e--) {
        ...
        if (!(r && (v || !(n.caseSensitive ? y : (b ??= y.toLowerCase())).startsWith(r)))) {
          if (o) {
            if (v) continue;
            let e = t.slice(a).join(`/`).slice(-o.length);
            if ((n.caseSensitive ? e : e.toLowerCase()) !== o) continue;
          }
          c.push({
            node: n,
            index: s,
      ...
      if (!v)
        for (let e = i.optional.length - 1; e >= 0; e--) {
          ...
          if (r || o) {
            ...
            if ((r && !e.startsWith(r)) || (o && !e.endsWith(o))) continue;
          }
          c.push({
            node: n,
            index: a + 1,
          ...
          (t.dynamics > e.dynamics ||
            (t.dynamics === e.dynamics &&
              (t.optionals > e.optionals ||
                (t.optionals === e.optionals &&
                  ((t.node.kind === N) > (e.node.kind === N) ||
                    ((t.node.kind === N) == (e.node.kind === N) && t.depth > e.depth)))))))
    : !0;
}
function le(e) {
...
function pe({ base: e, to: t, trailingSlash: n = `never`, cache: r }) {
  let a = t.startsWith(`/`),
    o = !a && t === `.`,
    s;
  if (r) {
  ...
  if (o) c = e.split(`/`);
    ...
    for (c = e.split(`/`); c.length > 1 && i(c) === ``; ) c.pop();
    let n = t.split(`/`);
  ...
  c.length > 1 && (i(c) === `` ? n === `never` && c.pop() : n === `always` && c.push(``));
  let l = J(c.join(`/`)) || `/`;
...
function he({ path: e, params: t, decoder: n, ...r }) {
  let i = !1,
    a = Object.create(null);
...
var Q = e(r(), 1),
  _e = Q.use,
  ve = typeof window < `u` ? Q.useLayoutEffect : Q.useEffect;
function ye(e) {
  let t = Q.useRef({ value: e, prev: null }),
    n = t.current.value;
...
function xe(e) {
  let t = Q.useRef(null);
  return (Q.useImperativeHandle(e, () => t.current, []), t);
}
var Se = t((e) => {
    var t = Symbol.for(`react.transitional.element`),
  ...
  $ = Ce();
function we({ children: e, fallback: t = null }) {
  return Te() ? (0, $.jsx)(Q.Fragment, { children: e }) : (0, $.jsx)(Q.Fragment, { children: t });
}
function Te() {
...
function Pe(e, t, n = Ne) {
  let r = (0, Q.useCallback)(
    ...
    i = (0, Q.useCallback)(() => e?.get(), [e]);
  return (0, Me.useSyncExternalStoreWithSelector)(r, i, i, t, n);
}
export {
  C as A,
  y as B,
