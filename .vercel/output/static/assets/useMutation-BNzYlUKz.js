...
import { G as t } from "./useStore-75krDqnZ.js";
import {
  B as n,
  F as r,
  H as i,
...
var u = class extends s {
    ...
    setOptions(e) {
      ...
      ((this.options = this.#e.defaultMutationOptions(e)),
        ...
        l(t.mutationKey) !== l(this.options.mutationKey)
          ? this.reset()
...
function f(e, t) {
  let a = r(t),
    [s] = d.useState(() => new u(a, e));
  d.useEffect(() => {
    s.setOptions(e);
  }, [s, e]);
  let c = d.useSyncExternalStore(
      d.useCallback((e) => s.subscribe(o.batchCalls(e)), [s]),
      () => s.getCurrentResult(),
      () => s.getCurrentResult(),
    ),
    l = d.useCallback(
      (e, t) => {
        s.mutate(e, t).catch(n);
      },
      [s],
    );
  if (c.error && i(s.options.throwOnError, [c.error])) throw c.error;
