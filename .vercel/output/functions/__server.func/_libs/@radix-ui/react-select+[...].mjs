...
var SelectArrow = import_react.forwardRef((props, forwardedRef) => {
  ...
  const popperScope = usePopperScope(__scopeSelect);
  return useSelectContentContext(ARROW_NAME, __scopeSelect).position === "popper"
