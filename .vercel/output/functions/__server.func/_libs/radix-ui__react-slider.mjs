...
} from "./@radix-ui/react-arrow+[...].mjs";
import { t as composeEventHandlers } from "./radix-ui__primitive.mjs";
import {
  n as createContextScope,
  t as createCollection,
} from "./@radix-ui/react-collection+[...].mjs";
...
var Slider = import_react.forwardRef((props, forwardedRef) => {
  ...
  function updateValues(value2, atIndex, { commit } = { commit: false }) {
    ...
    const nextValue = clamp(
      roundValue(Math.round((value2 - min) / step) * step + min, decimalCount),
      [min, max],
    );
...
var SliderHorizontal = import_react.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderOrientationProvider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderImpl, {
      ...
      onStepKeyDown: (event) => {
        const isBackKey = BACK_KEYS[isSlidingFromLeft ? "from-left" : "from-right"].includes(
          event.key,
        );
        onStepKeyDown?.({
          event,
...
var SliderVertical = import_react.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderOrientationProvider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderImpl, {
      ...
      onStepKeyDown: (event) => {
        const isBackKey = BACK_KEYS[isSlidingFromBottom ? "from-bottom" : "from-top"].includes(
          event.key,
        );
        onStepKeyDown?.({
          event,
...
function SliderThumbProvider(props) {
  ...
  const resolvedName =
    name ?? (context.name ? context.name + (context.values.length > 1 ? "[]" : "") : void 0);
...
var SliderThumb = import_react.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderThumbProvider, {
    __scopeSlider,
    name,
    internal_do_not_use_render: ({ index, isFormControl }) =>
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderThumbTrigger, {
            ...thumbProps,
            ref: forwardedRef,
            __scopeSlider,
          }),
