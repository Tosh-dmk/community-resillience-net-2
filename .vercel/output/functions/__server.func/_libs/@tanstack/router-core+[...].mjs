...
function y$1(e) {
  ...
  for (let a = 0, s = e.length; a < s; a++)
    ((n = mn(e[a])), n && ((r += e.slice(t, a) + n), (t = a + 1)));
...
typeof globalThis != "undefined"
  ? Object.defineProperty(globalThis, L$1, {
      value: U,
      configurable: !0,
      writable: !1,
      enumerable: !1,
  ...
  : typeof window != "undefined"
    ? Object.defineProperty(window, L$1, {
        value: U,
        configurable: !0,
        writable: !1,
        enumerable: !1,
    ...
    : typeof self != "undefined"
      ? Object.defineProperty(self, L$1, {
          value: U,
          configurable: !0,
          writable: !1,
          enumerable: !1,
      ...
      : typeof global != "undefined" &&
        Object.defineProperty(global, L$1, {
          value: U,
          configurable: !0,
          writable: !1,
          enumerable: !1,
...
async function Dr(e, r, t) {
  ...
  return (
    C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), await N$1(e, r, $e(t))))),
    v$1 in t && (a.push(I(e.base, v$1)), s.push(je(tr(e.base), await N$1(e, r, Qe(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push($$1(t[P$1]))),
  ...
  if (a)
    for (let s = 0, i = a.length; s < i; s++) {
      ...
      if (u.parse.async && u.test(n))
        return ce(t, u.tag, await u.parse.async(n, new kr(e, r), { id: t }));
    }
  return o$1;
}
...
function Wo(e, r, t, n, a) {
  let s = e.base,
    i = f$1(e, a),
    u = Number(n),
    l = (u >= 0 && u.toString() === n) || Mr(n);
  if (F(s, a)) l && u !== u ? jr(e, r.i, n, i) : Ne(e, r.i, l ? n : '"' + n + '"', i);
  else {
    let g = s.assignments;
    ((s.assignments = t),
      l && u !== u ? jr(e, r.i, n, i) : Ne(e, r.i, l ? n : '"' + n + '"', i),
      (s.assignments = g));
  }
}
...
function Zr(e, r, t) {
  ...
  return (
    C in t && (a.push(I(e.base, C)), s.push(Ue(rr(e.base), E$1(e, r, $e(t))))),
    v$1 in t &&
      (a.push(I(e.base, v$1)), s.push(je(tr(e.base), E$1(e, r, e.type === 1 ? re() : Qe(t))))),
    P$1 in t && (a.push(I(e.base, P$1)), s.push($$1(t[P$1]))),
    R in t && (a.push(I(e.base, R)), s.push(t[R] ? H : J)),
    {
      k: a,
...
function ha(e, r, t) {
  if (this.state.alive) {
    let n = W(this, r, t);
    (n && se(this, c$1(23, e, o$1, o$1, o$1, o$1, o$1, [k(this.base, 2), n], o$1, o$1, o$1, o$1)),
      be(this));
  }
}
function za(e, r, t) {
...
function Da(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    ...
    if (u.parse.stream && u.test(n))
      return ce(t, u.tag, u.parse.stream(n, new Hr(e, r), { id: t }));
  }
  return o$1;
}
function cn(e, r, t, n) {
