      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "flex items-center gap-2 self-start sm:self-center bg-card border border-border rounded-full px-4 py-2 shadow-sm shrink-0",
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
                  ...
                  className:
                    "text-xs font-semibold text-muted-foreground uppercase cursor-pointer select-none",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                  ...
                  className:
                    "size-4 text-brand-500 rounded border-border focus:ring-brand-500 cursor-pointer",
                }),
              ],
            }),
          ],
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  selected &&
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "absolute z-[1000] bottom-4 left-4 right-4 rounded-2xl bg-card/95 p-6 shadow-soft backdrop-blur-sm sm:left-6 sm:right-auto sm:max-w-sm",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                              className:
                                "text-xs font-bold uppercase tracking-widest text-brand-400",
