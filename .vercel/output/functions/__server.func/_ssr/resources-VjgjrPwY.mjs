        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
              ...
              children:
                "Practical, plain-language guides for every stage of recovery — plus live updates on the programs available to you.",
            }),
          ],
        }),
                  ...
                  children: guides.map((g) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      Link,
                      {
                        ...
                        className:
                          "rounded-2xl border border-border bg-card p-6 transition-all hover:shadow-soft block text-left",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className:
                              "mb-4 flex size-11 items-center justify-center rounded-2xl bg-brand-100 text-brand-800",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                            className:
                              "text-[11px] font-bold uppercase tracking-wide text-brand-400",
                            children: g.tag,
                          }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
                  className:
                    "mb-6 flex items-center gap-2 font-serif text-2xl font-semibold text-foreground",
                  children: [
