...
import { O as Menu, Q as ChevronLeft, T as Moon, Z as ChevronRight, c as TriangleAlert, j as Info, n as X, u as Sun, y as Radio } from "../_libs/lucide-react.mjs";
...
var organizationsQuery = () => queryOptions({
	queryKey: ["aid_organizations"],
	queryFn: async () => {
		try {
			const { data, error } = await supabase.from("aid_organizations").select("*").order("created_at", { ascending: true });
			if (error) throw error;
			if (!data || data.length === 0 || data.some((o) => o.name.includes("FEMA"))) return KENYAN_ORGS;
			return data;
		} catch (err) {
...
var supportGroupsQuery = () => queryOptions({
	queryKey: ["support_groups"],
	queryFn: async () => {
		try {
			const { data, error } = await supabase.from("support_groups").select("*").order("member_count", { ascending: false });
			if (error) throw error;
			if (!data || data.length === 0 || data.some((g) => g.name.includes("Flood Survivors Together"))) return KENYAN_GROUPS;
			return data;
		} catch (err) {
...
var reliefUpdatesQuery = () => queryOptions({
	queryKey: ["relief_updates"],
	queryFn: async () => {
		try {
			const { data, error } = await supabase.from("relief_updates").select("*").order("created_at", { ascending: false });
			if (error) throw error;
			if (!data || data.length === 0 || data.some((u) => u.title.includes("FEMA"))) return KENYAN_UPDATES;
			return data;
		} catch (err) {
...
var assistanceCentersQuery = () => queryOptions({
	queryKey: ["assistance_centers"],
	queryFn: async () => {
		try {
			const { data, error } = await supabase.from("assistance_centers").select("*").order("created_at", { ascending: true });
			if (error) throw error;
			if (!data || data.length === 0 || data.some((c) => c.name.includes("Asheville") || c.region === "Western Region")) return KENYAN_CENTERS;
			return data;
		} catch (err) {
...
var myReportsQuery = (userId) => queryOptions({
	queryKey: ["disaster_reports", userId],
	enabled: !!userId,
	queryFn: async () => {
		const { data, error } = await supabase.from("disaster_reports").select("*").eq("user_id", userId).order("created_at", { ascending: false });
		if (error) throw error;
		return data ?? [];
	}
});
...
function getAlertAction(update) {
	...
	if (t.includes("grant") || t.includes("cash") || t.includes("transfer") || t.includes("msme")) return {
		label: "View funding",
		to: "/funding"
	};
	if (update.severity === "high") return {
		label: "View map",
		to: "/map"
	};
	if (t.includes("guide") || t.includes("iron") || t.includes("distribution")) return {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [isHigh ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "relative flex size-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inline-flex h-full w-full animate-ping rounded-full bg-white opacity-75" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "relative inline-flex size-2 rounded-full bg-white" })]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
						...
						children: [isHigh ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TriangleAlert, {
							className: "size-3.5 shrink-0",
							"aria-hidden": "true"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [alerts.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
//#endregion
export { organizationsQuery as a, myReportsQuery as i, ThemeProvider as n, reliefUpdatesQuery as o, assistanceCentersQuery as r, supportGroupsQuery as s, PageShell as t };
