...
import {
  a as organizationsQuery,
  n as ThemeProvider,
  o as reliefUpdatesQuery,
  r as assistanceCentersQuery,
  s as supportGroupsQuery,
} from "./PageShell-DcwVYdMv.mjs";
import { t as RouteError } from "./route-boundaries-vglIa9qS.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
import {
  a as OrganizationsSkeleton,
  i as MapSkeleton,
  o as ResourcesSkeleton,
  r as FundingSkeleton,
  t as CommunitySkeleton,
} from "./Skeletons-DGtzFcLY.mjs";
...
function UssdSimulator({ onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "w-full max-w-sm rounded-2xl border border-border bg-card py-3 px-4 shadow-soft select-none font-sans",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "rounded-full bg-emerald-50 px-1.5 py-0.5 text-[8px] font-bold uppercase tracking-wider text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
            className:
              "text-[9px] font-bold uppercase tracking-wider text-muted-foreground block mb-0.5",
                ...
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, {
                      className: "size-2 fill-current shrink-0",
                    }),
                    btn.label,
                  ],
                },
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        className:
          "mx-auto w-54 rounded-2xl bg-neutral-800 p-2 border-2 border-neutral-700 shadow-xl flex flex-col items-center",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
            className:
              "w-full h-28 bg-[#8fa48c] border-2 border-[#788e75] rounded-md p-1.5 font-mono text-neutral-900 flex flex-col justify-between shadow-inner",
            children:
              screen === "dial"
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                              type: "text",
                              className:
                                "flex-1 min-w-0 bg-transparent outline-none border-b border-neutral-800 text-[11px] font-bold font-mono text-neutral-900 h-4",
                              value: menuInput,
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                ...
                variant: "outline",
                className:
                  "bg-neutral-700 text-neutral-300 hover:bg-neutral-600 border-neutral-600 text-[9px] px-1.5 h-6.5 cursor-pointer",
              ...
              screen === "dial"
                ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    onClick: handleDial,
                    className:
                      "size-7 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white flex items-center justify-center shadow-lg transition-transform hover:scale-105 cursor-pointer",
                    title: "Dial Code",
                ...
                : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                    ...
                    className:
                      "size-7 rounded-full bg-red-600 hover:bg-red-500 text-white flex items-center justify-center shadow-lg transition-transform hover:scale-105 cursor-pointer",
                    title: "Hang Up",
            ...
            children: ["1", "2", "3", "4", "5", "6", "7", "8", "9", "*", "0", "#"].map((key) =>
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
                  ...
                  disabled: isDemoRunning,
                  className:
                    "h-7 rounded bg-neutral-700 hover:bg-neutral-600 text-neutral-100 font-bold border border-neutral-650 flex flex-col items-center justify-center text-xs transition-colors active:bg-neutral-550 cursor-pointer disabled:opacity-50",
      ...
      onClose &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
            size: "xs",
            className:
              "rounded-xl px-3 py-1 bg-red-600 hover:bg-red-700 text-white text-[9px] font-bold uppercase tracking-wider cursor-pointer h-7",
            onClick: onClose,
    ...
    children: [
      !isOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
          ...
          className:
            "flex items-center gap-2 rounded-full bg-neutral-900 text-white hover:bg-neutral-800 border border-neutral-700 px-4 py-3 shadow-2xl transition-all duration-300 transform hover:scale-105 cursor-pointer font-semibold text-xs tracking-wider uppercase",
          children: [
      ...
      isOpen &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "w-80 rounded-3xl bg-neutral-900 text-white border border-neutral-800 shadow-2xl p-5 animate-in slide-in-from-bottom-5 fade-in-50 duration-300",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
                  className:
                    "font-serif font-bold text-lg flex items-center gap-2 text-neutral-100",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
                      className:
                        "text-[11px] font-bold uppercase tracking-wider text-neutral-400 mb-2.5",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          size: "sm",
                          className:
                            "w-full justify-start bg-neutral-800 hover:bg-neutral-700 text-neutral-200 border border-neutral-700/50 text-xs font-medium cursor-pointer",
                          onClick: () => handleAutofill("nyando"),
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, {
                              className: "size-3.5 mr-2 text-amber-400 shrink-0",
                            }),
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
                          ...
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PhoneIncoming, {
                              className: "size-3.5 mr-2 text-blue-400 shrink-0",
                            }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
                      className: "size-4 text-neutral-400 shrink-0 mt-0.5",
                    }),
...
function NotificationToast() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
    className:
      "fixed inset-x-0 top-4 z-[1000000] flex flex-col items-center gap-3 pointer-events-none px-4",
    children: [
      sms &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
          className:
            "w-full max-w-sm rounded-3xl bg-neutral-900 text-white p-4 shadow-2xl border border-neutral-800 flex items-start gap-3 pointer-events-auto animate-in slide-in-from-top-4 duration-300",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              className:
                "size-10 rounded-full bg-blue-600 flex items-center justify-center text-white shrink-0",
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                      className:
                        "font-bold text-sm tracking-wide flex items-center gap-1.5 text-blue-400",
                      children: [
      ...
      stk &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          className:
            "fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center z-[999999] pointer-events-auto p-4",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            className:
              "w-full max-w-xs rounded-2xl bg-neutral-100 text-neutral-900 border-4 border-neutral-300 p-5 shadow-2xl animate-in zoom-in-95 duration-200 font-mono",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "flex items-center gap-2 mb-4 justify-center border-b border-neutral-300 pb-2",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
                    className: "size-5 text-emerald-600 animate-pulse",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                    ...
                    placeholder: "••••",
                    className:
                      "w-full text-center bg-white border border-neutral-300 rounded px-3 py-2 text-xl font-bold tracking-widest focus:outline-none focus:ring-2 focus:ring-emerald-500",
                    value: pin,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                        ...
                        variant: "outline",
                        className:
                          "flex-1 bg-white hover:bg-neutral-200 border-neutral-300 text-xs h-9 cursor-pointer",
                        onClick: () => {
                          setStk(null);
                          setPin("");
                        },
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                        type: "submit",
                        className:
                          "flex-1 bg-emerald-600 hover:bg-emerald-700 text-white text-xs h-9 cursor-pointer",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, {
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, {
        children: [
          isNavigating &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
          ...
          isUssdOpen &&
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
              ...
              className:
                "fixed inset-0 z-[99999] bg-black/60 backdrop-blur-md flex items-center justify-center p-4 cursor-pointer",
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                onClick: (e) => e.stopPropagation(),
                className: "relative animate-in zoom-in-95 duration-200 cursor-default",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UssdSimulator, {
...
var Route$12 = createFileRoute("/sitemap.xml")({
  server: {
    handlers: {
      GET: async () => {
        const xml = [
...
var rootRouteChildren = {
  IndexRoute,
  AuthenticatedRouteRoute: AuthenticatedRouteRoute._addFileChildren(
