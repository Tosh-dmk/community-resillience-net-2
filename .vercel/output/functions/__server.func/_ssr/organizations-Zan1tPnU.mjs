...
function Organizations() {
	...
	const filtered = (0, import_react.useMemo)(() => {
		...
		return orgs.filter((o) => {
			...
			const matchesQuery = !q || o.name.toLowerCase().includes(q) || o.description.toLowerCase().includes(q) || o.tags.some((t) => t.toLowerCase().includes(q));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: filtered.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
								...
								children: o.name
							}), o.verified && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: o.region
							}), o.tags.slice(0, 2).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-md bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground",
								children: t
							}, t))]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-sm",
								children: [o.amount_label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-semibold text-foreground",
									children: o.amount_label
								}), o.deadline && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
									className: "block text-xs text-muted-foreground",
									children: ["Deadline: ", o.deadline]
								})]
							}), o.website ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								size: "sm",
								className: "rounded-full",
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									...
									children: ["Apply ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, {
										className: "size-3.5",
										"aria-hidden": "true"
									})]
								})
