...
var donateMpesa = createServerFn({ method: "POST" })
  .validator((d) => DonateInput.parse(d))
  .handler(createSsrRpc("08c0f4a1c7011e203225a5b0245a2799f753c0109e9955231e482d967e4ae04e"));
var campaigns = [
  {
    id: "c1",
...
function DonateModal({ campaign, onClose }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      className:
        "w-full max-w-md rounded-3xl bg-card border border-border p-6 shadow-xl relative animate-in fade-in zoom-in-95 duration-200",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
          onClick: onClose,
          className:
            "absolute right-4 top-4 text-muted-foreground hover:text-foreground cursor-pointer",
        ...
        mutation.isSuccess
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 text-center",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                  className: "size-8 text-emerald-500 mx-auto mb-2",
                }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                      ...
                      className:
                        "w-full rounded-lg border border-border bg-background px-3 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-accent",
                      value: phone,
      ...
      children: [
        ...
        submitted
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, {
                  className: "size-12 text-emerald-500 mx-auto mb-4",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
                          ...
                          className:
                            "w-full rounded-lg border border-border bg-background px-3 py-2 text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-accent",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "rounded-lg bg-amber-50 dark:bg-amber-950/50 border border-amber-200/50 p-3 text-xs text-amber-800 dark:text-amber-300",
                      children: [
...
function Funding() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, {
    children: [
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mb-3 inline-flex items-center gap-2 rounded-full border border-accent/25 bg-accent/10 px-3 py-1 text-xs font-semibold text-accent",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BadgeDollarSign, {
                    className: "size-3.5",
                  }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                ...
                children:
                  "Climate finance exists. HopeBridge helps communities find it. Browse verified grants, cash transfers, and adaptation programs — and apply in minutes.",
              }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                className:
                  "mt-5 flex items-center gap-2.5 rounded-xl border border-amber-200/60 bg-amber-50/80 px-4 py-2.5 dark:bg-amber-950/30 dark:border-amber-800/40",
                children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BadgeDollarSign, {
                    className: "size-4 inline mr-1.5",
                  }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  ...
                  children: filteredOpportunities.map((op) =>
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                      "article",
                      {
                        className:
                          "flex flex-col rounded-2xl border border-border bg-card p-5 transition-all hover:shadow-soft",
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              op.ussd &&
                                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                  ...
                                  className:
                                    "flex items-center gap-1 text-[10px] font-bold text-amber-600 dark:text-amber-400",
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WifiOff, {
                                      className: "size-3",
                                    }),
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            ...
                            children: op.tags.slice(0, 3).map((t) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                                "span",
                                {
                                  className:
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                                className: "mt-1 text-xs text-muted-foreground",
                                children: [pct, "% funded • ", c.donors, " donors"],
                              }),
                            ],
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
      ...
      selectedOpportunity &&
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GrantApplyModal, {
