            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mb-5 inline-flex items-center gap-2 rounded-full border border-accent/25 bg-accent/10 px-3.5 py-1.5 text-xs font-semibold text-accent",
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
                    className:
                      "font-serif text-4xl font-semibold leading-[1.1] text-foreground md:text-6xl",
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    ...
                    children:
                      "HopeBridge connects climate-affected communities with emergency grants, cash assistance, vetted aid organizations, and resilience programs — accessible online or offline via USSD.",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mt-8 flex items-center gap-3 rounded-2xl border border-border bg-card px-4 py-3",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "flex size-8 shrink-0 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-950",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        className:
                          "flex size-8 items-center justify-center rounded-xl bg-brand-100 text-brand-800",
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(s.icon, {
                      className: "mx-auto size-5 text-accent mb-2",
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "mb-4 inline-flex items-center gap-2 rounded-full bg-amber-100 px-3 py-1 text-xs font-bold uppercase tracking-wider text-amber-800 dark:bg-amber-950 dark:text-amber-300",
                    children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                    ...
                    children:
                      "In rural and flood-affected areas, connectivity disappears when it's needed most. HopeBridge's USSD interface works on any feature phone, with no data required.",
                  }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                className:
                  "flex items-center justify-center bg-gradient-to-br from-brand-100/60 to-accent/10 p-8 md:p-12 dark:from-brand-100/10 dark:to-accent/5",
                children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className:
                    "w-48 rounded-2xl bg-neutral-800 p-2 border-2 border-neutral-700 shadow-xl",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "h-28 bg-[#8fa48c] border-2 border-[#788e75] rounded-md p-2 font-mono text-neutral-900 text-[9px] leading-tight flex flex-col gap-0.5",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className:
                            "text-center font-bold tracking-widest py-0.5 border-b border-neutral-700/20 mb-1 text-xs",
                          children: "*483*111#",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          className: "font-bold",
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          children: "1. Report Hazard",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          children: "2. Request Supplies",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          children: "4. Nearest Shelter",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                          children: "5. Talk to Chief",
                        }),
                      ],
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                      ...
                      children: ["1", "2", "3", "4", "5", "6", "7", "8", "9", "*", "0", "#"].map(
                        (k) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            ...
                            {
                              className:
                                "h-5 rounded bg-neutral-700 flex items-center justify-center text-neutral-300 text-[8px] font-bold",
                              children: k,
                            },
                            k,
                          ),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
          ...
          children: actions.map((a) =>
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              ...
              {
                className:
                  "group relative overflow-hidden rounded-3xl border border-border bg-card p-8 transition-all hover:shadow-soft",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                    className:
                      "mb-6 flex size-12 items-center justify-center rounded-2xl bg-brand-100 text-brand-800",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                nearest &&
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    className:
                      "absolute z-[1000] bottom-4 left-4 right-4 max-w-sm rounded-2xl bg-card/95 p-6 shadow-soft backdrop-blur-sm sm:bottom-6 sm:left-6",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
                        ...
                        children: [nearest.address, " • ", nearest.services.slice(0, 3).join(", ")],
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, {
                  className: "mb-4 size-8 text-primary-foreground/60",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  ...
                  children:
                    "Connect with others who have faced similar challenges. Share resources, find volunteers, or talk with people who understand.",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  className: "mt-8 flex flex-wrap gap-3",
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                      ...
                      variant: "outline",
                      className:
                        "rounded-full border-primary-foreground/30 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground",
                      children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
                        to: "/community",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  ...
                  children:
                    "HopeBridge provides coordination dashboards, beneficiary tracking, and climate-finance analytics for organizations operating at scale.",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                  className: "mt-8",
