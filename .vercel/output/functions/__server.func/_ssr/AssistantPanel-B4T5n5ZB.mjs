...
import { A as LoaderCircle, U as ExternalLink, _ as Send, p as Sparkles } from "../_libs/lucide-react.mjs";
...
var askAssistant = createServerFn({ method: "POST" }).validator((d) => Input.parse(d)).handler(createSsrRpc("a25da347868e1aa3590e1280af68cec37d48865abed05dc6d83b2e090c30c963"));
var categoryLabel = {
...
function AssistantPanel({ initialSituation = "", situation: controlledSituation, setSituation: controlledSetSituation }) {
	...
	const mutation = useMutation({ mutationFn: (value) => callAssistant({ data: { situation: value } }) });
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("form", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						size: "lg",
						children: mutation.isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "animate-spin" }), " Finding aid"] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Send, {}), " Find Aid"] })
					})]
				})
			}),
			mutation.isError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "rounded-xl border border-destructive/30 bg-destructive/5 p-4 text-sm text-destructive",
				children: mutation.error.message
			}),
			mutation.data && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), mutation.data.recommended.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "grid gap-4 sm:grid-cols-2",
					children: mutation.data.recommended.map((org) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), org.amount_label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							org.website && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
										...
										children: ["Apply ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "ml-1.5 size-3" })]
									})
								})
							})
						]
