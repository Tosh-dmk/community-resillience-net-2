...
var statusOrder = ["submitted", "under_review", "matched", "in_progress", "resolved"];
var statusLabel = {
  submitted: "Submitted",
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
      ...
      children: [
              ...
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
                    to: "/report",
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FilePlusCorner, {
                        className: "size-4",
                      }),
                      " New report",
                    ],
        ...
        reports.length === 0
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mt-10 rounded-3xl border border-dashed border-border bg-card p-10 text-center",
              children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                  ...
                  children:
                    "Report what happened and what you need. We'll match you with relevant aid and support right away.",
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                  asChild: true,
              ...
              children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
                            className: "space-y-2",
                            children: blueprint.steps.map((step, i) =>
                                ...
                                "li",
                                {
                                  ...
                                  children: [
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                                      className:
                                        "flex size-5 shrink-0 items-center justify-center rounded-full bg-accent text-[10px] font-bold text-accent-foreground mt-0.5",
                                      children: i + 1,
                                    }),
                                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            className:
                              "mt-4 flex items-center gap-2 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200/50 px-3 py-2",
                            children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
                            className: "space-y-3",
                            children: matchedGrants.map((grant) =>
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                                "div",
                                {
                                  className:
                                      ...
                                      children: [
                                        ...
                                        grant.ussd &&
                                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                            className:
                                              "text-[10px] text-amber-600 flex items-center gap-0.5 justify-end",
                                            children: [
                                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WifiOff, {
                                                className: "size-2.5",
                                              }),
                ...
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      className:
                        "rounded-2xl border border-amber-200/60 bg-amber-50 dark:bg-amber-950/30 p-5",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
                          ...
                          className:
                            "mt-3 text-xs font-semibold text-amber-800 dark:text-amber-300 underline cursor-pointer",
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                          ...
                          children:
                            "Access the full operations dashboard to manage beneficiaries and coordinate climate-finance disbursements.",
                        }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
                          asChild: true,
                          size: "sm",
                    ...
                    recommended.map((o) =>
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        Link,
                        {
                          to: "/organizations",
                          className:
                            "block rounded-2xl border border-border bg-card p-5 transition-colors hover:border-accent/40",
                          children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
